...
# cliente actualizado (con soporte XDR - use este si desea la vista detallada de la matriz):
g++ -std=c++17 -pthread src/network/client_tcp_v2.cpp src/network/xdr_serialization.cpp -I. -o cliente_v2
```
...
**Nota Importante:** Este sistema es de demostración educativa. Para producción:
