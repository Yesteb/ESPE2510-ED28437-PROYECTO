...
#include "src/red/Sincronizacion.h"
#include "src/red/Servidor.h"
...
int main() {
    ...
    // ====== INICIAR SINCRONIZACION (escucha broadcast de otras instancias) ======
    Sincronizacion::iniciar(&lista);

    // ====== INICIAR SERVIDOR TCP ======
    Servidor::iniciar(60000, archivo);
