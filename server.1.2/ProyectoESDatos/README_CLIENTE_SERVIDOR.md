...
```bash
cd ProyectoESDatos
g++ -std=c++17 -pthread src/red/client_tcp.cpp -I. -o cliente
```
...
├── src/red/
│   ├── Servidor.h / Servidor.cpp     (servidor TCP)
│   ├── Sincronizacion.h / Sincronizacion.cpp (sincronización UDP - opcional)
